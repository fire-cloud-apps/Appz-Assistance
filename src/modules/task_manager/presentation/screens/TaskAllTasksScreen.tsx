import { Box, Button, Stack, Text, Loader, Center, Group, Badge, Paper, ThemeIcon, UnstyledButton, Divider, Tooltip, ActionIcon } from '@mantine/core'
...
export function TaskAllTasksScreen() {
  ...
  const { openCreateModal, setSelectedTaskId } = useTaskStore()
  ...
  return (
    <Box style={{ position: 'relative', minHeight: '100%' }}>
      <Stack gap="md">
        <TaskDashboardHeader title="All Tasks" onNewTask={openCreateModal} />
